		...
		<div class="notice">
			<div class="title">
				...
				<div class="notice_btn">
					<a class="notice_modify" href="/php/modify_notice.php?id=<?= $row["id"] ?>">
					<a class="notice_delete" href="/php/delete_notice.php?id=<?= $row["id"] ?>">
				</div>
			</div>
			<div class="content">
				<p><?= $row["content"] ?></p>
		...
		<div class="comment">
				...
				<div>
					...
					<div class="comment_btn">
						<a class="comment_modify" href="/php/modify_comment.php">
						<a class="comment_delete" href="/php/delete_comment.php">
					</div>
				</div>
				<hr>
				<?php } ?>
