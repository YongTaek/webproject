		...
		<div class="notice">
			<div class="title">
				...
				<div class="notice_btn">
					<a class="notice_modify" href="/php/modify_notice.php?id=<?= $row["id"] ?>">수정</a>
					<a class="notice_delete" href="/php/delete_notice.php?id=<?= $row["id"] ?>">삭제</a>
				</div>
			</div>
			<div class="content">
				<p><?= $row["content"] ?></p>
		...
		<div class="comment">
				...
				<div>
					...
					<div class="comment_btn">
						<a class="comment_modify" href="/php/modify_comment.php">수정</a>
						<a class="comment_delete" href="/php/delete_comment.php">삭제</a>
					</div>
				</div>
				<hr>
				<?php } ?>
